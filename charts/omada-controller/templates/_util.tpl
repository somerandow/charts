{{- /*
omada-controller.resourceName sets the name of a resource based on the chart and release name, and optionally, a
...
*/}}
{{- define "omada-controller.resourceName" -}}
{{- $ctx := .ctx -}}
{{- $extraResourceName := .extraResourceName -}}
{{- if $ctx.Values.nameOverride }}
